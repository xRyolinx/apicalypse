    ...
    <main className='bg-main text-black'>
        ...
        <section>
            ...
            bg-red-00'>
                    ...
                    border-solid border-[3px] border-transparent border-b-slate-600
                    min-w-[120px] text-center px-[20px] py-[5px] text-[13px]'>
                        All Transactions
                    </p>
                    <p className='font-semibold
                    border-solid border-[3px] border-transparent border-b-slate-200
                    min-w-[120px] text-center px-[20px] py-[5px] text-[13px]'>
                        Income
                    </p>
                    <p className='font-semibold
        ...
        <section className='pt-[40px]'>
            <h1 className='font-bold text-[20px] mb-[15px]'>Expence Tracking Overview</h1>
